...
| Langage | Ce qu'il sait faire | Sa limite | Qui l'utilise |
|---|---|---|---|
| **Python** | Tout le chemin : lire, nettoyer, tracer, entraîner, servir | Lent dès qu'on écrit des boucles à la main | Data scientists, ingénieurs IA, chercheurs |
| **R** | Statistiques et graphiques, avec une élégance rare (ggplot2) | Sort mal de la stat ; mise en production pénible | Statisticiens, biostatistique, recherche, marketing |
| **SQL** | Interroger des données déjà rangées, même des milliards de lignes | Ne sait que ça : pas de graphique, pas de modèle | Tout le monde, en entreprise |
| **Rust / C++** | Aller très vite, contrôle total de la mémoire | Long à écrire, très peu de bibliothèques data | Ceux qui écrivent les moteurs : NumPy, Polars, les serveurs de modèles |
| **JavaScript** | Faire vivre une page web, des graphiques interactifs | Écosystème data et IA très pauvre | Développeurs web, tableaux de bord |
...
| | 0 | 1 |
|---|---|---|
| Langage | « Python parce que c'est ce que je connais » | Je sais dire quelle bibliothèque fait le travail à ma place |
...
|---|---|---|
| 1 · Langage | ____________________ | bibliothèque principale : ____________________ |
